...
def fazer_pedido(delivery=False):
    ...
    if clientes[cliente]['pedidos'] >= 5:
     print('\nParabéns! Você chegou a 5 pedidos!')
     #Quando o cliente completa 5 pedidos ele é parabenizado

    LIMITE_PEDIDOS = 10

    if clientes[cliente]["pedidos"] >= LIMITE_PEDIDOS:
     print("❌ Limite de pedidos atingido.")
     return
    # Este bloco limita o pedido do cliente a 10, Caso ele ultrapasse uma mensagem é enviada "Limite de pedidos atingido."
